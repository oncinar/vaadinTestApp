...
- testApp-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- testApp-ui: main application module, development time
- testApp-production: module that produces a production mode WAR for deployment
