package onur.testApp.client.samples;
...
import onur.testApp.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@onur.testApp.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
