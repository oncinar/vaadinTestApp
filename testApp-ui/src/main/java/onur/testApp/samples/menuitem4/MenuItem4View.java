package onur.testApp.samples.menuitem4;
...
public class MenuItem4View extends MenuItemBaseView{

	private static final long serialVersionUID = 1L;
	public static final String VIEW_NAME = "Menu4";

    public MenuItem4View() {
    	super();
