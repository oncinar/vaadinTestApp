package onur.testApp.samples.menuitemTransportation;
...
public class MenuItemTransportationView extends MenuItemBaseView{

	private static final long serialVersionUID = 1L;
	public static final String VIEW_NAME = "Transportation";

    public MenuItemTransportationView() {
    	super();
