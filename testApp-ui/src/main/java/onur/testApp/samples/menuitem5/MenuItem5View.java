package onur.testApp.samples.menuitem5;
...
public class MenuItem5View extends MenuItemBaseView{

	private static final long serialVersionUID = 1L;
	public static final String VIEW_NAME = "Menu5";

    public MenuItem5View() {
    	super();
